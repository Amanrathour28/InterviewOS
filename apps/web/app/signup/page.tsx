...
import { Terminal, Eye, EyeOff, ArrowRight, AlertCircle, CheckCircle2 } from 'lucide-react';
    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4 bg-background bg-grid-pattern relative">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <p className="text-xs text-zinc-400">Join the next-generation technical interview platform</p>
        </div>
        ...
        <Card className="border-zinc-800 bg-[#0d0e14]/90 backdrop-blur-xl shadow-2xl">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription className="text-xs text-zinc-400">
              Get started with collaborative coding, system design, and AI evaluations.
            </CardDescription>
          </CardHeader>
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              ...
              {/* Email */}
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-zinc-300">Work or Personal Email</label>
                <input
                  type="email"
                  required
                  value={email}
